            ...
            <div className="flex w-11/12 lg:w-8/12 mx-auto justify-between flex-col md:flex-row">
                <div className="flex flex-col gap-8 w-[320px] md:w-full">
                    <div className="flex flex-col gap-4">
                        <p className="tracking-wider text-two font-bold">
                            TESTIMONIALS
                        </p>
                ...
                <div className="flex justify-end">
                    <div className="mr-4 md:mr-0 mt-10 md:mt-0 relative w-[300px] h-[400px] before:absolute before:w-full before:h-full before:top-8 before:left-8 before:bg-two border before:-z-10 z-10">
