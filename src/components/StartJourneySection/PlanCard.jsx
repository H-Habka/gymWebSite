    ...
    <div className="bg-gray-600 text-white flex flex-col gap-8 p-6 group relative z-10 md:hover:scale-110 hover:scale-105 transition-all duration-500">
      ...
      <div className="flex flex-col gap-4 ">
        <div className="flex justify-between">
          ...
          {couponDiscountAmount && !isExpired ? (
            <div>
      ...
      <div className="">
        {+discountedPrice === +price || isExpired? (
      ...
      <a
        href={`https://api.whatsapp.com/send?phone=971565561153&text=${`${whatsappMessage} - Coupon Code: ${couponCode}`}`}
        target="_blank"
        rel="noreferrer"
      >
